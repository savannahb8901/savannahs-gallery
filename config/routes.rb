Rails.application.routes.draw do
  ...
  # CREATE
  post("/insert_collection_category", { :controller => "collection_categories", :action => "create" })
          
  # READ
  get("/collection_categories", { :controller => "collection_categories", :action => "index" })
  
  get("/collection_categories/:path_id", { :controller => "collection_categories", :action => "show" })
  
  # UPDATE
  
  post("/modify_collection_category/:path_id", { :controller => "collection_categories", :action => "update" })
  
  # DELETE
  get("/delete_collection_category/:path_id", { :controller => "collection_categories", :action => "destroy" })
